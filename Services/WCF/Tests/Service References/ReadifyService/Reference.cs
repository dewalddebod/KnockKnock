...
namespace Readify.Services.WCF.Tests.ReadifyService {
    ...
    public interface IRedPill {
        ...
        Readify.Services.WCF.Tests.ReadifyService.TriangleType WhatShapeIsThis(int a, int b, int c);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://KnockKnock.readify.net/IRedPill/WhatShapeIsThis", ReplyAction="http://KnockKnock.readify.net/IRedPill/WhatShapeIsThisResponse")]
        System.Threading.Tasks.Task<Readify.Services.WCF.Tests.ReadifyService.TriangleType> WhatShapeIsThisAsync(int a, int b, int c);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRedPillChannel : Readify.Services.WCF.Tests.ReadifyService.IRedPill, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RedPillClient : System.ServiceModel.ClientBase<Readify.Services.WCF.Tests.ReadifyService.IRedPill>, Readify.Services.WCF.Tests.ReadifyService.IRedPill {
        ...
        public Readify.Services.WCF.Tests.ReadifyService.TriangleType WhatShapeIsThis(int a, int b, int c) {
            return base.Channel.WhatShapeIsThis(a, b, c);
        }
        
        public System.Threading.Tasks.Task<Readify.Services.WCF.Tests.ReadifyService.TriangleType> WhatShapeIsThisAsync(int a, int b, int c) {
